    ...
    <div class="w-full px-4 mx-auto max-w-7xl sm:px-6 xl:px-0">
        <div class="flex flex-col gap-5 lg:gap-8 lg:flex-row">
            ...
            <div class="w-full lg:w-2/3">
                ...
                <div>
                    <!-- Meta -->
                    <span class="flex items-center gap-3 my-4 text-sm text-gray-500">
                    ...
                    <div class="flex flex-wrap items-center justify-between gap-10 mt-10 border-t border-gray-200 pt-8">
                        ...
                        <div class="flex gap-3">
                            <button data-sharer="facebook" data-url="<?php echo esc_url(get_the_permalink()); ?>" aria-label="facebook" style="background-color: transparent; border: none; padding: 0px; cursor: pointer; outline: none;">
                            ...
                            <button data-sharer="twitter" data-title="<?php echo esc_attr(get_the_title()); ?>" data-url="<?php echo esc_url(get_the_permalink()); ?>" aria-label="twitter" style="background-color: transparent; border: none; padding: 0px; cursor: pointer; outline: none;">
                            ...
                            <button data-sharer="linkedin" data-url="<?php echo esc_url(get_the_permalink()); ?>" aria-label="linkedin" style="background-color: transparent; border: none; padding: 0px; cursor: pointer; outline: none;">
                ...
                <div class="shadow-sm bg-white rounded-xl border border-gray-100 mt-8">
                    ...
                    <div class="p-4 sm:p-6">
                        <div class="flex flex-col gap-6">
                            <?php
                            $exclude_cat = get_category_by_slug('chinh-sach');
