<template>
  <section class="py-12 bg-dark-900">
    <div class="container mx-auto px-4">
      ...
      <div v-if="loading && hasVideos" class="text-center py-6 mt-4">
...
watch([isIntersecting, loading, hasNext], ([intersecting, isLoading, hasNextVal]) => {
  if (intersecting && !isLoading && hasNextVal) {
